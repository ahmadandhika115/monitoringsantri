          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> Edit Data Hafalan Santri<small></small></h3>
              </div>
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Edit Data Hafalan</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/hafalan_siswa/aksi_edit.php" method="post">
                      <?php
                        $idDetailPoin=$_GET['id_detail_poin'];

                        $hafalan=mysqli_query($connect, "SELECT * FROM detail_poin JOIN siswa ON detail_poin.nis=siswa.nis JOIN hafalan ON detail_poin.id_hafalan=hafalan.id_hafalan WHERE id_detail_poin='$idDetailPoin'");
                        $pres=mysqli_fetch_array($hafalan);
                        $nis=$pres['nis'];
                        $namaSiswa=$pres['nama_siswa'];
                        $idHafalan=$pres['id_hafalan'];
                        $namaHafalan=$pres['nama_hafalan'];
                      ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input value="<?php echo $idHafalan." - ".$namaHafalan; ?>" type="text" name="hafalan" id="autocomplete-hafalan" class="form-control col-md-10" style="float: left;" />
                          <div id="autocomplete-container" style="position: relative; float: left; width: 400px; margin: 10px;"></div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="reset" class="btn btn-primary" onclick="window.location='main.php?module=input_hafalan_siswa'">Cancel</button>
