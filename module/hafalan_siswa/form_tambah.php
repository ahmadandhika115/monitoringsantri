          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> Input Data Hafalan Santri<small></small></h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Tambah Data Hafalan</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/hafalan_siswa/aksi_simpan.php" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="hafalan" id="autocomplete-hafalan" class="form-control col-md-10" style="float: left;" required="required" />
                          <div id="autocomplete-container" style="position: relative; float: left; width: 400px; margin: 10px;"></div>
                        </div>
                      </div>
                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                        $hafalan=mysqli_query($connect, "SELECT * FROM detail_poin JOIN siswa ON detail_poin.nis=siswa.nis JOIN hafalan ON detail_poin.id_hafalan=hafalan.id_hafalan WHERE tahun_ajaran='$thAjaran' ORDER BY tanggal DESC");
                        $no=1;
                        while($plg=mysqli_fetch_array($hafalan)){
                        $idDetailPoin=$plg['id_detail_poin'];
                         ?>
                        <tr>
                          <td><?php echo $no; ?></td>
                          <td><?php echo $plg['tanggal']; ?></td>
                          <td><a href="main.php?module=detail_siswa&nis=<?php echo $plg['nis'];?>&sb=input_hafalan"><?php echo $plg['nis']; ?></a></td>
                          <td><a href="main.php?module=detail_siswa&nis=<?php echo $plg['nis'];?>&sb=input_hafalan"><?php echo $plg['nama_siswa']; ?></a></td>
                          <td><?php echo $plg['nama_hafalan']; ?></td>
                          <td>
                            <div class="btn-group">
                              ...
                              <a href="module/hafalan_siswa/aksi_hapus.php?id_detail_poin=<?php echo $idDetailPoin;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm" style="margin-left: 0.1cm;"><i class='fa fa-trash'></i></button></a>              
                            </div>
                          </td>
                        </tr>
