          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <a href="main.php?module=laporan_hafalan"><button type="button" class="btn btn-round btn-primary"><i class="glyphicon glyphicon-arrow-left"></i> Kembali</button> </a>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <h4 align="center">Laporan Hafalan Santri</h4>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        $poin_hafalan=mysqli_query($connect, "SELECT SUM(hafalan.poin) AS jml FROM detail_poin JOIN hafalan ON detail_poin.id_hafalan=hafalan.id_hafalan WHERE detail_poin.nis='$nis'");
                        $pp=mysqli_fetch_array($poin_hafalan);
                        $totPoin=$pp['jml'];

                         ?>
                        <tr>
                          <td><?php echo $no; ?></td>
                          <td><a href="main.php?module=detail_siswa&nis=<?php echo $sw['nis'];?>&sb=laporan_hafalan&id_kelas=<?php echo $idKelas;?>"><?php echo $sw['nis']; ?></a></td>
                          <td><a href="main.php?module=detail_siswa&nis=<?php echo $sw['nis'];?>&sb=laporan_hafalan&id_kelas=<?php echo $idKelas;?>"><?php echo $sw['nama_siswa']; ?></td>
