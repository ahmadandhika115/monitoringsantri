          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Hafalan Santri</h3>
              </div>
            </div>
            
            <div class="clearfix"></div>

            <!-- Siswa Dengan Hafalan Terbanyak -->
                ...
                <div class="">
                  <div class="x_content">
                      <div class="row tile_count">
                        <?php
                          $terbanyak=mysqli_query($connect, "SELECT detail_poin.nis, SUM(hafalan.poin) AS poin, siswa.nama_siswa FROM detail_poin JOIN hafalan ON detail_poin.id_hafalan=hafalan.id_hafalan JOIN siswa ON detail_poin.nis=siswa.nis GROUP BY detail_poin.nis ORDER BY SUM(hafalan.poin) DESC LIMIT 6");
                          $no=1;
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-6 tile_stats_count">
                          ...
                          <div class="count">
                            <a class="pull-left border-blue profile_thumb" style="color:#0099FF">
            ...
            <!-- Pelanggaran Siswa Dengan Hafalan Terbanyak -->
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                            ...
                            <table class="data table table-striped no-margin">
                              ...
                              <tbody>
                                 <?php 
                                    ...
                                    $poin_kelas = mysqli_query($connect,"SELECT kelas.id_kelas, kelas.tingkat_kelas, jurusan.nama_jurusan, kelas.sub_kelas, SUM(hafalan.poin) AS jml FROM detail_poin JOIN siswa ON detail_poin.nis=siswa.nis JOIN kelas ON siswa.id_kelas=kelas.id_kelas JOIN jurusan ON kelas.id_jurusan=jurusan.id_jurusan JOIN hafalan ON detail_poin.id_hafalan=hafalan.id_hafalan WHERE kelas.id_kelas='$idKelas'");
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="btn-group">
                                      <a href="main.php?module=detail_hafalan_siswa&id_kelas=<?php echo $idKelas; ?>" class="btn btn-info btn-sm" ><i class='fa fa-eye'></i> Lihat Detail</a>
                                    </div>
                                  </td>
                                </tr>
                                <?php 
                            ...
                            <!-- end hafalan per kelas -->

                          </div>

                          <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                            <!-- start hafalan per jurusan -->
                            <table class="data table table-striped no-margin">
                              <thead>
                                <tr>
                                  <th>No</th>
                              ...
                              <tbody>
                                 <?php 
                                    ...
                                    $id_jurusan=$jur['id_jurusan'];
                                      $poin_jurusan=mysqli_query($connect, "SELECT jurusan.nama_jurusan, SUM(hafalan.poin) AS jml FROM jurusan JOIN kelas ON jurusan.id_jurusan=kelas.id_jurusan JOIN siswa ON kelas.id_kelas=siswa.id_kelas JOIN detail_poin ON siswa.nis=detail_poin.nis JOIN hafalan ON detail_poin.id_hafalan=hafalan.id_hafalan WHERE jurusan.id_jurusan='$id_jurusan'");
                            ...
                            <!-- end hafalan per jurusan -->

                          </div>

                          <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                           <!-- start hafalan per jenis hafalan -->
                                    ...
                                    <table class="data table table-striped no-margin">
                                      ...
                                      <tbody>
                                        <?php
                                            ...
                                            $hafalan=mysqli_query($connect, "SELECT * FROM hafalan ORDER BY id_hafalan");
                                              $id=1;
                                              while($pres=mysqli_fetch_array($hafalan)){
                                                $idHafalan=$pres['id_hafalan'];

                                                $poin_hafalan=mysqli_query($connect, "SELECT COUNT(hafalan.poin) AS jml FROM hafalan JOIN detail_poin ON hafalan.id_hafalan=detail_poin.id_hafalan WHERE hafalan.id_hafalan='$idHafalan' AND detail_poin.tahun_ajaran='$thAjaran'");
                                                $pPres=mysqli_fetch_array($poin_hafalan);
