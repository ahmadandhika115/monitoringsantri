          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> Input Data Pelanggaran Santri<small></small></h3>
              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <a href="module/pelanggaran_siswa/aksi_hapus.php?id_detail_poin=<?php echo $idDetailPoin;?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm" style="margin-left: 0.1cm;"><i class='fa fa-trash'></i></button></a>
