<?php
    ...
    if ($querySimpan) {
        echo "<script> alert('Data Prestasi Santri Berhasil Masuk'); window.location = '$base_url'+'main.php?module=input_prestasi_siswa';</script>";
    }
    else {
        echo "<script> alert('Data Pelanggaran Santri Gagal Dimasukkan'); window.location = '$base_url'+'main.php?module=tambah_prestasi_siswa';</script>";
